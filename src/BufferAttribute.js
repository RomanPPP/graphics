...
const floatAttribSetter = (props) =>{
    const {numComponents, type,  location, numAttributes, stride, offset, buffer, gl, divisor} = props
...
export {BufferAttribute,  createIndicesBuffer, AttributeSetter, BufferController} 